...
<div class="wp-block-group wolf-music-themes-hero__content">
	...
	<!-- /wp:paragraph -->
	<!-- wp:heading {"level":1,"textAlign":"center","className":"wolf-music-themes-hero__title","fontSize":"display"} -->
	...
	<!-- /wp:heading -->
	<!-- wp:paragraph {"align":"center","className":"wolf-tagline","fontSize":"md"} -->
