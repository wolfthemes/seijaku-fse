			...
			<Column>
				...
				>
					<Heading
						level={ 3 }
						textAlign="center"
					>{ `<a href="<?php echo esc_url( home_url( '/theme-category/music/' ) ); ?>">Music</a>` }</Heading>
					<Paragraph textAlign="center" fontSize="sm">
						Bands, labels &amp; festivals
					</Paragraph>
				</Cover>
			</Column>
			<Column>
				...
				>
					<Heading
						level={ 3 }
						textAlign="center"
					>{ `<a href="<?php echo esc_url( home_url( '/theme-category/creative/' ) ); ?>">Creative</a>` }</Heading>
					<Paragraph textAlign="center" fontSize="sm">
						Studios, agencies &amp; portfolios
					</Paragraph>
				</Cover>
			</Column>
			<Column>
				...
				>
					<Heading
						level={ 3 }
						textAlign="center"
					>{ `<a href="<?php echo esc_url( home_url( '/theme-category/portfolio/' ) ); ?>">Portfolio</a>` }</Heading>
					<Paragraph textAlign="center" fontSize="sm">
