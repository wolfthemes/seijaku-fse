		...
		<Columns verticalAlignment="center">
			<Column width="60%" className="wolf-about__main">
				...
				<Heading level={2} className="wolf-about__title">
					I'm Constantin. For 14 years, I've been the only person writing every line of WolfThemes.
				</Heading>
				<Paragraph className="wolf-about__text">
					No agency, no rotating dev team, no outsourced support tickets. Every theme here started as a
				...
				<Paragraph className="wolf-about__text">
					When you reach out, you're talking to the person who built the theme, not a queue. That's the
					whole reason I started selling direct.
				</Paragraph>
			</Column>
			<Column width="40%" className="wolf-about__pullquote">
				<Block name="core/paragraph">
					{`14 years.<br>36,000 customers.<br>4.5/5 out of 1600+ ratings.<br>One person who still answers the emails.`}
				</Block>
			</Column>
		</Columns>
	</Section>
