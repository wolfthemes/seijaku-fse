	...
	>
		<Container align="wide" className="wolf-footer__top">
			<Columns verticalAlignment="center">
				...
				<Column width="33.33%">
					<Paragraph className="wolf-footer__tagline">
						Themes built to look sharp, move fast, and convert.
					</Paragraph>
				</Column>
				<Column width="33.33%">
		...
		<Container align="wide" className="wolf-footer__nav">
			<Container className="wolf-footer__col">
				...
				<List className="wolf-footer__links">
					...
					<ListItem>
						<Link href="/wordpress-themes">All Themes</Link>
					</ListItem>
					<ListItem>
						<Link href="/music-wordpress-themes">Music Themes</Link>
					</ListItem>
					<ListItem>
			...
			<Container className="wolf-footer__col">
				...
				<List className="wolf-footer__links">
					<ListItem>
						<Link
							href="https://wiki.wolfthemes.com/"
							rel="noopener"
							target="_blank"
						>
							Knowledge Base
			...
			<Container className="wolf-footer__col">
				...
				<List className="wolf-footer__links">
					<ListItem>
						<Link
							href="https://facebook.com/wolfthemes"
							rel="noopener"
							target="_blank"
						>
							Facebook
					...
					<ListItem>
						<Link
							href="https://instagram.com/wolfthemes"
							rel="noopener"
							target="_blank"
						>
							Instagram
			...
			<Container className="wolf-footer__col">
				...
				<List className="wolf-footer__links">
					<ListItem>
						<Link href="mailto:hello@wolfthemes.com">
							hello@wolfthemes.com
						</Link>
					</ListItem>
				</List>
			</Container>
